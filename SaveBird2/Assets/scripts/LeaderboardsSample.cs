...
public class LeaderboardsSample : MonoBehaviour
{
    ...
    const string LeaderboardId = "Best_players";
    ...
    public async void AddScore(float pontuacao)
    {
        var scoreResponse = await LeaderboardsService.Instance.AddPlayerScoreAsync(LeaderboardId, pontuacao);
    ...
    // testando inserção nome de usuario

    public async void setPlayerName(string nome)
    {
        await AuthenticationService.Instance
        .UpdatePlayerNameAsync(nome);
